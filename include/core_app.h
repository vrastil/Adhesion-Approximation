...
void set_unpert_pos(const Sim_Param &sim, std::vector<Particle_x>& particles);
void set_unpert_pos_w_vel(const Sim_Param &sim, std::vector<Particle_v>& particles, const std::vector< Mesh> &vel_field);
void set_pert_pos(const Sim_Param &sim, const FTYPE db, std::vector<Particle_x>& particles, const std::vector< Mesh> &vel_field);
void set_pert_pos_w_vel(const Sim_Param &sim, const FTYPE db, std::vector<Particle_v>& particles, const std::vector< Mesh> &vel_field);

void upd_pos_first_order(const Sim_Param &sim, const FTYPE da, const FTYPE a, std::vector<Particle_v>& particles, const std::vector< Mesh> &vel_field);
void upd_pos_second_order(const Sim_Param &sim, const FTYPE da, const FTYPE a, std::vector<Particle_v>& particles, const std::vector< Mesh> &force_field);
void upd_pos_second_order_w_pp(const Sim_Param &sim, const FTYPE da, const FTYPE a, std::vector<Particle_v>& particles, const std::vector< Mesh> &force_field,
...
int get_vel_from_par(const std::vector<Particle_v>& particles, std::vector<Mesh>& vel_field, const Sim_Param &sim);
int get_vel_from_par(const std::vector<Particle_x>& particles, std::vector<Mesh>& vel_field, const Sim_Param &sim);
...
void force_short(const Sim_Param &sim, const FTYPE D, const LinkedList& linked_list, const std::vector<Particle_v>& particles,
