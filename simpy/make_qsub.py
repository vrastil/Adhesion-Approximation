...
def make_qsub(job):
    ...
    qsub += ("#PBS -j oe\n"
             ...
             "export LD_LIBRARY_PATH=$MYDIR/local/lib:$LD_LIBRARY_PATH\n"
             "export CPATH=$MYDIR/local/include:$CPATH:/software/fftw-3.3/amd64_linux26.double/include/\n"
             "export LIBRARY_PATH=$MYDIR/local/lib:$LIBRARY_PATH:/software/fftw-3.3/amd64_linux26.double/lib:/software/fftw-3.3/amd64_linux26.omp_double/lib\n"
             "cd $SCRATCHDIR\n"
